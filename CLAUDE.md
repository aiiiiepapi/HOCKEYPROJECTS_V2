...
| Raw data lake — Liiga | COMPLETE minus 2 recovering: 449/450/480/479 games (2023-2026), branch liiga-data-lake. 2 rescheduled games live at odd API ids (2023 Tappara-Lukko, 2026 Lukko-Pelicans) — fetcher patched to recover via games-list. CRITICAL FIND: api/v2 swapped penaltyEvents home<->away vs v1; adapter auto-detects (root homeTeamPlayers marker), equivalence gate added (gate 12) | 2026-08-01 |
| Raw data lake — EIHL | v1 cache only (port when EIHL expansion is greenlit) | 2026-07-24 |
| hockeycore.gap | not started — will be written FRESH (v1 code is reference only, not trusted) | 2026-07-24 |
