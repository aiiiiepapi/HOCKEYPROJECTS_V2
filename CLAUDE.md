...
| Raw data lake — Mestis | COMPLETE & MANAGER-VERIFIED 2026-08-03: 1,166 games / 4 seasons (364/312/245/245), 4 artifacts/game, ICS-reconciled 0/0 both directions, all manifests re-hashed ok. Branch mestis-data-lake on the V2 REPO (v1 token 403 — convention question open with Seb). Explicit goalie in/out events + pois intervals (COMPLEMENTARY channels — union at adapter, see docs/MESTIS_LAKE_VERIFICATION.md). HC per game-side 2,313/2,332 (99.2%) — handoff's 100% claim corrected; 19 blanks listed for a coach map. Adapter not started (Manager builds, queue point 2) | 2026-08-03 |
