...
def main():
    ...
    notes = [
        ...
        "NO-GO for real money (Seb ruling). Leader market = Overs only.",
        "-3.5 = CAUTION (2026-07-26): model runs ~4pts optimistic on this market — demand DOUBLE the edge or skip.",
        "Provenance: MC grid n=30k seed 7 w/ in-sim penalties + desperation rates; blind-validated 25-26 (lead1 bias cut to +2.4).",
        "",
